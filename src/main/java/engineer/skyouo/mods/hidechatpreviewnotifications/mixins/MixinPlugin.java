...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        boolean result = HideChatPreviewNotifications.mixins.get(mixinClassName) != null && HideChatPreviewNotifications.mixins.get(mixinClassName).getSpecifiedVersion().contains(DetectedVersion.BUILT_IN.getName());
        if (result) {
